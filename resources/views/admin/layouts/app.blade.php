...
<head>
    ...
    <title>SIGEB | Bomberos Yerba Buena</title>
...
<body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav me-auto">
                        <li class="nav-item">
                            <a href="{{ route('posts.index') }}" class="nav-link">Novedades</a>
                        </li>
                        <li class="nav-item">
    ...
    <script src="{{ asset('vendor/loader/build/bootstrap-waitingfor.min.js') }}"></script>
